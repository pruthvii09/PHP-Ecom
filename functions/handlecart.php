    ...
    if (isset($_POST['scope'])) {
        ...
        switch ($scope) {
            case 'add':
                ...
                $chk_esixting_cart = "SELECT * FROM carts WHERE prod_id='$prod_id' AND user_id='$user_id'";
                $chk_esixting_cart_run = mysqli_query($conn, $chk_esixting_cart);
                if (mysqli_num_rows($chk_esixting_cart_run) > 0) {
                    echo "Exisiting";
                } else {
